...
const api = axios.create({ baseURL: 'http://192.168.108.78:8000/api' })
// const api = axios.create({ baseURL: process.env.VUE_APP_API_URL || `http://${window.location.hostname}:8000/api` })
